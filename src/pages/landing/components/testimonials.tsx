...
function Testimonials() {
  return (
    <section className="flex flex-col items-center h-[810px] mt-[110px] mb-[100px] px-14">
      ...
      <p className="w-[280px] md:w-[596px] lg:w-full text-sm md:text-[1.75rem] leading-5 md:leading-10 text-center tracking-[0.2px] text-gray-400">
      ...
      <Button title="More Testimonials" bold bgBlue />
    </section>
  );
}
